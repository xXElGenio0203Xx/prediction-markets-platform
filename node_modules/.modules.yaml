...
hoistedDependencies:
  ...
  '@inquirer/prompts@7.9.0(@types/node@22.18.13)':
  ...
  '@vitest/mocker@2.1.9(vite@5.4.21(@types/node@20.19.24))':
  ...
  anymatch@3.1.3:
    anymatch: private
  apps/backend:
    '@prediction-markets/backend': private
  apps/frontend:
    '@prediction-markets/frontend': private
  aproba@2.1.0:
    aproba: private
  ...
  inherits@2.0.4:
    inherits: private
  inquirer@12.10.0(@types/node@22.18.13):
    inquirer: private
  internal-slot@1.1.0:
  ...
  packages/shared:
    '@prediction-markets/shared': private
  parent-module@1.0.1:
  ...
  vite-node@2.1.9(@types/node@20.19.24):
    vite-node: private
  vitest@2.1.9(@types/node@20.19.24):
    vitest: private
...
pendingBuilds: []
prunedAt: Wed, 19 Nov 2025 22:18:23 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - '@rollup/rollup-win32-x64-gnu@4.52.5'
  - '@rollup/rollup-win32-x64-msvc@4.52.5'
storeDir: /Users/christianschuetz/Library/pnpm/store/v3
